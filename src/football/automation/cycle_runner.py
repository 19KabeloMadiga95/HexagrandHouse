...
# =========================================================
# SHARED SQLITE FOOTBALL CYCLE RUNNER
# =========================================================
...
def _run_step(step: CycleStep, run_id: str, pipeline_name: str) -> dict[str, Any]:
    print("\n======================================")
...
def run_logged_cycle(
    *,
    ...
    subtitle: str = "SQLite-first runtime mode",
) -> dict[str, Any]:
    ...
    for step in steps:
        try:
            logs.append(_run_step(step, run_id=run_id, pipeline_name=pipeline_name))
        except Exception:
    ...
    status_df = _write_refresh_status(pipeline_name, run_id, logs, cycle_start, cycle_end)
