...
# =========================================================
# POWERBALL SOURCE CONFIG
# =========================================================

SOURCE_NAME = "za.national-lottery.com"

POWERBALL_HISTORY_URL = "https://za.national-lottery.com/powerball/results/history"
POWERBALL_PLUS_HISTORY_URL = "https://za.national-lottery.com/powerball-plus/results/history"
...
GAME_CONFIGS = [
    {
        ...
        "game_name": "PowerBall",
        "draw_type": "Main",
        "history_url": POWERBALL_HISTORY_URL,
        "archive_pattern": "https://za.national-lottery.com/powerball/results/{year}-archive",
    },
    {
        "game_family": "PowerBall",
        "game_name": "PowerBall Plus",
        "draw_type": "Plus",
        "history_url": POWERBALL_PLUS_HISTORY_URL,
        "archive_pattern": "https://za.national-lottery.com/powerball-plus/results/{year}-archive",
    },
]
...
if __name__ == "__main__":
    ...
    print("\n======================================")
    print("POWERBALL SCRAPER TEST COMPLETE")
    print("======================================")
