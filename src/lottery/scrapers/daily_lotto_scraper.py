...
# =========================================================
# DAILY LOTTO SOURCE CONFIG
# =========================================================

SOURCE_NAME = "za.national-lottery.com"

DAILY_LOTTO_HISTORY_URL = "https://za.national-lottery.com/daily-lotto/results/history"
...
GAME_CONFIGS = [
    {
        ...
        "draw_type": "Main",
        "history_url": DAILY_LOTTO_HISTORY_URL,
        "archive_pattern": "https://za.national-lottery.com/daily-lotto/results/{year}-archive",
    }
]
...
def parse_archive_page(
    ...
    for idx, match in enumerate(matches):
        ...
        # Daily Lotto has 5 regular numbers, no bonus.
        if len(numbers) < 5:
            continue
...
def scrape_daily_lotto_history(
    start_year=None,
    end_year=None,
    sleep_seconds=0.3
):
...
if __name__ == "__main__":
    ...
    print("\n======================================")
    print("DAILY LOTTO SCRAPER TEST COMPLETE")
    print("======================================")
