...
def fitness_score(
    ...
    # Historical duplication penalty
    ...
    # Bonus currently gets neutral score.
    # It is still evolved/mutated, but not over-weighted.
    score += 1
...
def run_uk49s_genetic_optimizer():
    df = load_uk49s_features()

    if len(df) < 50:
        print(
            "\nWARNING: UK49s history is still limited. "
            "Optimizer will run, but results should be treated as experimental.\n"
        )
    ...
    for item in final_population:
        ...
        rows.append({
            ...
            "ModelVersion": "UK49sGeneticOptimizer_v1",
    ...
    print("\n======================================")
    print("UK49S GENETIC OPTIMIZATION COMPLETE")
    print("======================================")
