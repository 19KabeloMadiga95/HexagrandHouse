...
def run_powerball_genetic_optimizer():
    ...
    for idx, item in enumerate(final_population):
        genome = item["Genome"]
        ...
        rows.append({
            ...
            "ModelVersion": "GeneticPOWERBALLOptimizer_v1",
    ...
    with pd.ExcelWriter(
        ...
        results_df.to_excel(
            writer,
            sheet_name="POWERBALL_Optimized_Numbers",
            index=False
        )
    ...
    print("\n======================================")
    print("GENETIC POWERBALL OPTIMIZATION COMPLETE")
    print("======================================")
