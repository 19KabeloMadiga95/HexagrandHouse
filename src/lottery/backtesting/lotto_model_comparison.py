...
OUTPUT_FILE = (
    EXPORT_DIR
    / "lotto_model_comparison_backtest.xlsx"
)
...
def load_lotto_features(game_name="Lotto"):
...
def run_lotto_model_comparison_backtest(
    game_name="Lotto",
...
def export_lotto_model_comparison_backtest(
    game_name="Lotto",
    test_draws=TEST_DRAWS,
    predictions_per_draw=PREDICTIONS_PER_DRAW,
):
    ...
    results_df = run_lotto_model_comparison_backtest(
        game_name=game_name,
        test_draws=test_draws,
        predictions_per_draw=predictions_per_draw,
    )
